  ...
  const load = useCallback(async () => {
    try {
      ...
      const next = await listProjects();
       ...
       setIsLead(currentUser.role === "LEAD_ENGINEER" || currentUser.role === "SUPERUSER");
